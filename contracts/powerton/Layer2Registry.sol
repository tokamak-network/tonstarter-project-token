...
//     require(owner() == msg.sender || Layer2I(layer2).operator() == msg.sender, "sender is neither operator nor operator");
//     _;
//   }

//   function layer2s(address layer2) external override view returns (bool) {
//     return _layer2s[layer2];
//   }

//   function numLayer2s() external override view returns (uint256) {
//     return _numLayer2s;
//   }

//   function layer2ByIndex(uint256 index) external override view returns (address) {
...
//   function unregister(address layer2) external override onlyOwner returns (bool) {
//     require(_layer2s[layer2]);
