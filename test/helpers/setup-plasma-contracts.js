...
async function setupPlasmaContracts(account) {
...
const version = "1.0";
  ...
  // await stake1Proxy.connect(deployer).setImplementation(stake1Logic.address, 1, true);

  // await stake1Proxy.connect(deployer).upgradeTo(stake1Logic.address, 1);
...
module.exports = { setupPlasmaContracts };
