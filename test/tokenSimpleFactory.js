...
describe("TokenSimpleFactory", function() {
  ...
  it("deploy ERC20SimpleFactory ", async function() {
    const ERC20AFactory = await ethers.getContractFactory("ERC20SimpleFactory");
  ...
  it("deploy ERC20Simple ", async function() {
